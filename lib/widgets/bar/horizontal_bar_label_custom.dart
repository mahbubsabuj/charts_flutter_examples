...
class HorizontalBarLabelCustom extends StatefulWidget {
  const HorizontalBarLabelCustom({Key? key}) : super(key: key);

  @override
  State<HorizontalBarLabelCustom> createState() => _HorizontalBarLabelCustomState();
}

class _HorizontalBarLabelCustomState extends State<HorizontalBarLabelCustom> {
